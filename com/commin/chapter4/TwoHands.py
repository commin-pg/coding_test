...
# 내가 같은걸 냈는데, 상대방한테 내가 나보다 쌘게 있으면 내가 지는거임
...
if len(set(MS_lst)) == 1 and TK_lst.count(srp.get(set(MS_lst).pop())) >= 1:
    print("TK")
elif len(set(TK_lst)) == 1 and MS_lst.count(srp.get(set(TK_lst).pop())) >= 1:
    print("MS")
else:
    print("?")
